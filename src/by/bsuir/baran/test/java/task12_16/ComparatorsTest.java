...
class ComparatorsTest extends Book {
    ...
    @Test
    public void testByTitleComparator() {
        setUp();
    ...
    @Test
    public void testByAuthorTitleComparator() {
        setUp();
    ...
    @Test
    public void testByTitleAuthorComparator() {
        setUp();
    ...
    @Test
    public void testByAuthorTitlePriceComparator() {
        setUp();
